...
public class Main {
        ...
        while (flag) {
            ...
            switch (input) {
                ...
                case 1:
                    ...
                    } else skipForward(iterator);
                    break;
                case 2:
                    if (forward) {
                        forward = false;
                        iterator.previous();
                        skipBackward(iterator);
                    } else skipBackward(iterator);
    ...
    private static void skipBackward(ListIterator iterator) {
    ...
    private static void skipForward(ListIterator iterator) {
        if (iterator.hasNext()) {
    ...
    private static int menu() {
        System.out.println("Please enter the action number: \n" +
                ...
                "3 to list the songs in playlist");
